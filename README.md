...
1. [JavaScript Chess Board](https://sam-deguzman.github.io/batch5-activities/Chess_BoardJS/index.html) - still uses Grid for the layout same as the previous one and now has functions of Moving Pieces, Castling, Taking turn (White First), Timer and En Passant using DOM manipulation and JavaScript functions. 
